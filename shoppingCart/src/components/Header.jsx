...
export const Header = ({ cart }) => {
  ...
  return (
    <header>
      <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200  dark:border-b-1 dark:border-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex items-center md:gap-2 md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <Link to="/cart">
